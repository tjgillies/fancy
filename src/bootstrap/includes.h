...
#define METHOD(class, method_name)                                       \
  FancyObject* METHOD_FUNC(class, method_name)(FancyObject* self, FancyObject* *args, int argc, Scope *scope, Interpreter* interp)
...
#define CLASSMETHOD(class, method_name)                                       \
  FancyObject* CLASSMETHOD_FUNC(class, method_name)(FancyObject* self, FancyObject* *args, int argc, Scope *scope, Interpreter* interp)
...
#define FORWARD_METHOD(class, method_name)                      \
  METHOD_FUNC(class, method_name)(self, args, argc, scope, interp)

#define FORWARD_CLASSMETHOD(class, method_name)                 \
  CLASSMETHOD_FUNC(class, method_name)(self, args, argc, scope, interp)
